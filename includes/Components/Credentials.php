...
class Credentials {
    public function render() {
        ...
        echo '<input type="text" id="transmission_url" name="transmission_url" placeholder="Your transmission url" required  value="'.get_option('alli1d_transmission_url', '').'" />';
        echo '<br /><br />';
        echo '<label for="transmission_login">' . __('Transmission username', 'all-in-one-download') . '</label>';
        echo '<input type="text" id="transmission_login" name="transmission_login" placeholder="Your login here" required  value="'.get_option('alli1d_transmission_login', '').'" />';
        echo '<br /><br />';
        echo '<label for="transmission_pwd">' . __('Transmission password', 'all-in-one-download') . '</label>';
        echo '<input type="password" id="transmission_pwd" name="transmission_pwd" placeholder="'.__('Transmission password', 'all-in-one-download').'" required value="'.get_option('alli1d_transmission_pwd', '').'" />';
        echo '<br /><br />';
        ...
        try {
            ...
            $password = get_option('alli1d_transmission_pwd', '');
